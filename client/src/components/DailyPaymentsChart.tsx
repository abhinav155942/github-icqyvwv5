...
const DailyPaymentsChart: React.FC<DailyPaymentsChartProps> = ({ className = "" }) => {
  ...
  // Chart data representing daily payments for coaches
  const chartData = [
    { label: '20', value: 2800, height: 65 },
    { label: '30', value: 2200, height: 45 },
    { label: '35', value: 3400, height: 85 },
    { label: '40', value: 2600, height: 55 },
    { label: '45', value: 3800, height: 95 },
    { label: '50+', value: 2900, height: 70 }
  ];
    ...
    >
      ...
      <div className="relative h-64 mb-6">
        ...
        <motion.div
          ...
          className="absolute top-12 left-1/2 transform -translate-x-1/2 bg-slate-800 text-white px-4 py-2 rounded-lg text-sm z-10"
        >
          <div className="font-semibold">Avg: 3K</div>
        ...
        {/* Chart Bars */}
        <div className="flex items-end justify-between h-full pt-16">
