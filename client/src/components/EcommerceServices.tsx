...
const EcommerceServices = () => {
  const services = [
    {
      icon: TrendingDown,
      title: "E-commerce Funnel Setup",
      description: "High-converting product funnels with upsells, abandoned cart recovery, and automated email marketing to maximize your sales.",
      cost: 300
    },
    {
      icon: Bot,
      title: "AI Sales Assistant",
      description: "Intelligent chatbots that help customers find products, answer questions, and guide them through the purchase process.",
      cost: 300
    },
    {
      icon: Scissors,
      title: "Product Video Ads",
      description: "Create compelling product showcase clips and video ads from your content, optimized for social media advertising.",
      cost: 300
    }
  ];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto px-4">
            Boost your online sales with AI-powered automation and marketing tools
          </p>
        </div>
