...
const Hero = () => {
  ...
  return (
    <section className="hero-main min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 px-4 relative overflow-hidden" data-onboarding="hero">
